...
{
    public class CreateNoteTypeCommandValidator : AbstractValidator<CreateProfilOptionCommand<NoteType>>
    {
        public CreateNoteTypeCommandValidator(ParentEspoirDbContext context)
        {
            RuleFor(c => c.Name)
                .NotEmpty()
