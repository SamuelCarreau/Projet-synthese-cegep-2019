...
{
    public class CreateSchoolingCommandValidator : AbstractValidator<CreateProfilOptionCommand<Schooling>>
    {
        public CreateSchoolingCommandValidator(ParentEspoirDbContext context)
        {
            RuleFor(c => c.Name)
                .NotEmpty()
